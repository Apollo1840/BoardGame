...
代表如果该怪物只有一个技能或属性，该技能或属性每回合可以带来总价为1的效果收益。

2增配置：0.5
代表如果该怪物有2个技能，这些技能每回合可以带来总价为0.5的效果收益。
如果该怪物有1个技能，1个属性，该技能和属性每回合总共可以带来0.5的效果收益



注释：
- 总价为负数的词条不参与计算
- 品阶可以视作（1增，2增，多增的ID），品阶越高，说明（1增，2增，多增整体的效果值越高），其数值没有含义，只是大小描述了卡效强度。
